      ...
      <div className="md:h-[100vh] w-full rounded-md bg-zinc-950 relative flex flex-col items-center justify-center antialiased">
        <div className="max-w-3xl mx-auto p-4">
          <div className="flex flex-row justify-center items-center">
            <h1 className="relative z-20 text-3xl md:text-6xl bg-clip-text text-transparent bg-gradient-to-b from-zinc-200 to-zinc-600 text-center font-sans font-bold leading-normal md:leading-relaxed py-1">
              Comingsoon
            </h1>
          </div>
          <p className="text-zinc-400 max-w-lg mx-auto text-sm text-center relative z-30">
        ...
        <footer className="text-center p-4">
          ...
          © {date.getFullYear()}&nbsp;
          <span className="italic underline underline-offset-4">ardy.lol</span>
        </footer>
      </div>
      {/* </FollowerPointerCard> */}
    </>
